...
**Reactive state in Vue 3 is often wrapped in a Proxy object, but the structuredClone algorithm does not support Proxy objects as cloneable types.**
...
::vueTip{:type="tip" :reference="https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API/Structured_clone_algorithm#supported_types" :position="14"}

#text

Use toRaw to unwrap reactive objects before passing them to structuredClone, as Proxy objects are not cloneable.
